...
export const SECTION_DEFS = [
    {
        ...
        Icon: Shield,
        stripe: "bg-slate-500",
        headerBg: "from-slate-50 to-slate-100/60",
        headerHover: "hover:from-slate-100/80 hover:to-slate-100/80",
    ...
    },
    {
        ...
        headerHover: "hover:from-primary/15 hover:to-primary/15",
    ...
    },
    {
        ...
        headerBg: "from-brand-accent/5 to-brand-accent/10",
        headerHover: "hover:from-brand-accent/15 hover:to-brand-accent/15",
        border: "border-brand-accent/20",
        text: "text-brand-accent-foreground",
        iconBg: "bg-brand-accent/10",
        iconColor: "text-brand-accent",
        badge: "bg-brand-accent/10 text-brand-accent",
        fileBg: "bg-brand-accent/5",
        fileColor: "text-brand-accent/70",
    },
] as const;
